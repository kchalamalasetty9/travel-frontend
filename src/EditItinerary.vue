    ...
    <form @submit="handleSubmit">
      ...
      <div v-for="(day, index) in itinerary.days" :key="index">
        ...
        <div v-for="(destination, destIndex) in day.destinations" :key="destIndex">
          ...
          <br>
          <label for="date">Start Date:</label>
          <input type="date" id="startDate" v-model="destination.arrivalDate" required>

          <br>
          <label for="date">End Date:</label>
          <input type="date" id="endDate" v-model="destination.departureDate" required>
    ...
    try {
      ...
      itinerary.days = itinerary.days.map(day => {
        ...
        mappedDay.destinations = day.destinations.map(destination => {
          ...
          mappedDestination.arrivalDate = destination.arrival_date
          mappedDestination.departureDate = destination.departure_date
